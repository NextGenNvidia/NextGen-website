        ...
        <section className="relative bg-black py-32 px-4 md:px-8 overflow-hidden min-h-screen flex flex-col justify-center">
            ...
            <div className="max-w-7xl mx-auto w-full relative z-10">
                <motion.h2
                    ...
                    viewport={{ once: true }}
                    className="text-center mb-32 uppercase tracking-widest font-bold text-2xl md:text-3xl"
                >
                ...
                <div className="flex flex-col gap-40 relative">
                    ...
                    {initiatives.map((item, index) => (
                        ...
                        >
                            ...
                            >
                                <div
                                    className="relative p-10 border border-[#4DBC1B] rounded-none bg-black group hover:bg-[#4DBC1B]/10 transition-colors duration-500"
                                    style={{
                                ...
                                >
                                    ...
                                    <h3 className="text-4xl font-bold text-white mb-4 group-hover:text-[#4DBC1B] transition-colors uppercase tracking-tighter">{item.title}</h3>
